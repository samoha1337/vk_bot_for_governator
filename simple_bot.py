...
class Bot:
    ...
    def send_message(self, receiver_user_id: str = None, message_text: str = "Здравствуйте, Вас приветствует цифровой помощник главы Мирнинского района. Задайте Ваш вопрос."):
        """
