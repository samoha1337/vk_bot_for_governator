        ...
        for event in self.long_poll.listen():
            ...
            if event.type == VkEventType.MESSAGE_NEW and event.to_me and event.text:
                ...
                if event.from_user:
                    ...
                    if event.text == "Привет" or event.text == "Здравствуй" or event.text == "Здравствуйте" or event.text == "здравствуйте" or event.text == "привет" or event.text=="здравствуй":
                        self.send_message(receiver_user_id=event.user_id, message_text="Здравствуйте, Вас приветствует цифровой помощник главы Мирнинского района. Задайте Ваш вопрос.")
                    else:
